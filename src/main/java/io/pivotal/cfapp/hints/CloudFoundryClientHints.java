	...
	public List<HintDeclaration> computeHints(TypeSystem typeSystem) {
		Set<String> responseTypes =
			Set.of(
				...
				"org.cloudfoundry.uaa.serverinformation._GetInfoResponse",
				"org.cloudfoundry.client.v2.info._GetInfoResponse"
			);
							...
							typeSystem
								...
								.forTypes(type -> {
									return
										responseTypes
											.stream()
											.anyMatch(t -> typeSystem.resolveDotted(t).isAssignableFrom(type));
								})
								.stream()
						);
	}
